...
- ✅ Ссылки на ячейки из других листов (Sheet1!A1, Sheet2!B2)
- ✅ Суммирование и вычисления между листами
...
5. Используйте формулы:
   ...
   - `=A1*B1` - умножение
   - `=A1/B1` - деление
   - `=Sheet1!A1 + Sheet2!B2` - ссылки на ячейки из других листов
   - `=SUM(Sheet1!A1:A5, Sheet2!B1:B5)` - сумма диапазонов из разных листов
